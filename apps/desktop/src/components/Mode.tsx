...
import IconCapInfo from "~icons/cap/info";
...
const MODE_BUTTONS: ModeButtonConfig[] = [
	{
		mode: "instant",
		get label() {
			return t("modeSelector.instant.label");
		},
		get description() {
			return t("modeSelector.instant.description");
		},
	...
	},
	{
		mode: "studio",
		get label() {
			return t("modeSelector.studio.label");
		},
		get description() {
			return t("modeSelector.studio.description");
		},
	...
	},
	{
		mode: "screenshot",
		get label() {
			return t("modeSelector.screenshot.label");
		},
		get description() {
			return t("modeSelector.screenshot.description");
		},
	...
	return (
		<div class="flex relative gap-2 items-center p-1.5 rounded-full border border-gray-5 bg-gray-3 w-fit">
			<button
				...
				aria-label={t("modeSelector.recordingModeInfo")}
			>
									...
									<Show when={button.settingsSection}>
										{(section) => (
											...
											>
												...
												<span>{t("modeSelector.qualitySettings")}</span>
											</button>
										)}
									</Show>
								</div>
