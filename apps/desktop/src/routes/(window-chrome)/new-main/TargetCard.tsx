...
export default function TargetCard(props: TargetCardProps) {
	...
	const handleCopy = async (e: MouseEvent) => {
		...
		try {
			...
			toast.error(t("screenshot.messages.copyFailed"));
		}
	};
	...
	const handleSave = async (e: MouseEvent) => {
		...
		try {
			...
			toast.error(t("screenshot.messages.saveFailed"));
		}
	};
			...
			<div class="flex flex-col w-full">
				...
				<Show when={local.variant === "screenshot"}>
					<div class="flex items-center justify-between px-2 pb-1.5 pt-0.5 gap-1">
						<Tooltip content={t("recordingsPage.actions.edit")}>
							<div
								role="button"
								tabIndex={-1}
						...
						<Tooltip content={t("recordingsPage.actions.copyToClipboard")}>
							<div
								role="button"
								tabIndex={-1}
								onClick={handleCopy}
						...
						<Tooltip content={t("recordingsPage.actions.saveAs")}>
							<div
								role="button"
								tabIndex={-1}
								onClick={handleSave}
						...
						return (
							<div class="flex items-center justify-between px-2 pb-1.5 pt-0.5 gap-1">
								...
								<Show when={recording.sharing}>
									<Tooltip content={t("recordingsPage.actions.openLink")}>
										<div
											role="button"
											tabIndex={-1}
								...
								<Tooltip content={t("recordingsPage.actions.openBundle")}>
									<div
										role="button"
										tabIndex={-1}
								...
								<Tooltip content={t("recordingsPage.actions.delete")}>
									<div
										role="button"
										tabIndex={-1}
