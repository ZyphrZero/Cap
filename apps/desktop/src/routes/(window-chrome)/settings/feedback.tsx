			...
			<SettingsPageContent>
				...
				<Section title="常见问题">
					<div class="space-y-2">
						<For each={FAQ_ITEMS}>
							{(item, index) => (
								<div class="border border-gray-3 rounded-lg overflow-hidden bg-gray-1/50">
									<button
										type="button"
										onClick={() =>
											setExpandedIndex(
									...
									>
										...
										<span
											class={`text-gray-10 transition-transform duration-200 ${
							...
							const captureSupported =
								"screenCaptureSupported" in d
									...
									: "graphicsCaptureSupported" in d
										...
										: false;
							const availableEncoders = Array.isArray(d.availableEncoders)
								? d.availableEncoders.filter(
