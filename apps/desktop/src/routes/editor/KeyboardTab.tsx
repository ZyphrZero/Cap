				...
				>
						...
						<div class="space-y-3">
							<div class="flex flex-col gap-2">
								<span class="text-gray-11 text-sm">
									{t("editor.keyboardTab.fontFamily")}
								</span>
								<KSelect<string>
							...
							<div class="flex flex-col gap-2">
								<span class="text-gray-11 text-sm">
									{t("editor.keyboardTab.textColor")}
								</span>
								<HexColorInput
					...
					>
						<div class="space-y-3">
							<div class="flex flex-col gap-2">
								<span class="text-gray-11 text-sm">
									{t("editor.keyboardTab.backgroundColor")}
								</span>
								<HexColorInput
							...
							<div class="flex flex-col gap-2">
								<span class="text-gray-11 text-sm">
									{t("editor.keyboardTab.backgroundOpacity")}
								</span>
								<Slider
					...
					>
						<div class="space-y-3">
							<div class="flex flex-col gap-2">
								<span class="text-gray-11 text-sm">
									{t("editor.keyboardTab.fadeDuration")}
								</span>
								<Slider
							...
							<div class="flex flex-col gap-2">
								<span class="text-gray-11 text-sm">
									{t("editor.keyboardTab.lingerDuration")}
								</span>
								<Slider
							...
							<div class="flex flex-col gap-2">
								<span class="text-gray-11 text-sm">
									{t("editor.keyboardTab.groupingThreshold")}
								</span>
								<Slider
					...
					<Field
						name={t("editor.keyboardTab.behavior")}
						icon={<IconLucideKeyboard />}
					>
						<div class="space-y-3">
							<div class="flex flex-col gap-2">
								<div class="flex items-center justify-between">
									<span class="text-gray-11 text-sm">
										{t("editor.keyboardTab.showModifierKeys")}
									</span>
									<Toggle
							...
							<div class="flex flex-col gap-2">
								<div class="flex items-center justify-between">
									<span class="text-gray-11 text-sm">
										{t("editor.keyboardTab.showSpecialKeys")}
									</span>
									<Toggle
							...
							<div class="flex flex-col gap-2">
								<div class="flex items-center justify-between">
									<span class="text-gray-11 text-sm">
										{t("editor.keyboardTab.uppercase")}
									</span>
									<Toggle
					...
					<div class="pt-2">
						...
						>
							{isGenerating()
								...
								: hasKeyboardSegments()
									? t("editor.keyboardTab.regenerateSegments")
									: t("editor.keyboardTab.generateSegments")}
						</Button>
					</div>
					...
					<Show when={!hasKeyboardSegments()}>
						<div class="text-center text-sm text-gray-11 py-4">
							<p>{t("editor.keyboardTab.noSegments")}</p>
							<p class="text-xs mt-1 text-gray-10">
								{t("editor.keyboardTab.noSegmentsDescription")}
							</p>
						</div>
					</Show>
				</div>
